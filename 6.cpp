...
void tinhLaiSuat() {
    ...
    int tienLaiGiamMoiKy = 50000;

    printf("Tien vay: %d trieu\n", soTienVay);
    printf("Lai suat hang thang: %.2f%%\n", laiSuat * 100);
    printf("Ky han: %d thang\n", kyHan);

    for (int i = 0; i < kyHan; i++) {
        printf("Ky %d: Tra goc %d trieu, tra lai %d\n", i + 1, tienGocTraMoiKy, tienLaiKyDau);
        tienLaiKyDau -= tienLaiGiamMoiKy;
    }
}
...
// Them cac phep toan khac vao day

int main() {
    int chucNang;
    printf("Chon chuc nang (6-10): ");
    scanf("%d", &chucNang);
    ...
    switch (chucNang) {
        ...
        case 9:
            ...
            break;
        case 10:
            // Thuc hien cac phep toan voi phan so
            break;
        default:
